                    ...
                    <div class="col-md-4">
                                        ...
                                        <form action="save_schedule.php" method="post" id="schedule-form">
                                            ...
                                            <div class=" mb-2">
                                                ...
                                                <textarea rows="3"
                                                    ...
                                                    name="description" id="description12" required></textarea>
                                            </div>
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="events-wrapper">
                                ...
                                <?php
                                $result = $conn->query("SELECT * FROM `schedule_list` WHERE teacher_class_id = ''");
                                    ...
                                    <div class="modal-body">
                                        <form action="save_schedule.php" method="post" id="edit-schedule-form">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control description" id="description13"
                        ...
                        <?php
                        $schedules = $conn->query("SELECT * FROM `schedule_list` WHERE teacher_class_id = ''");
                        $sched_res = [];

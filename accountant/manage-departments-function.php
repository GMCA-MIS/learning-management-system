...
<?php 
    ...
    {       
        ...
        $query = "UPDATE department SET department_name='$department_name', dean='$dean' WHERE department_id = '$id'";
        $query_run = mysqli_query($conn, $query);
...
if(isset($_POST['add_department']))
{
    ...
    $insertQuery = "INSERT INTO department (department_name, dean) VALUES ('$department_name', '$dean')";

            ...
            <body class="is-preload">
                ...
                <div id="main" class="wrapper style1">
                    <div class="container">
                        ...
                        <section>
                            <form action="reenroll.php" method="post" enctype="multipart/form-data">
                                <!-- Requester's Name -->
                                <input type="hidden" name="student_id" value="<?php echo $row['student_id'] ?>" autocomplete="off" placeholder="LRN No." required readonly />
                                ...
                                <div class="row gtr-uniform gtr-50">
                                    <div class="col-12">
                                        <select name="grade_level" id="tor_purpose" required>
                                            <option value="">-- Select Grade Level --</option>
                                            <option value="11"<?php if ($row['grade_level'] == '11') echo ' selected'; ?>>
                                                Grade 11
                                            </option>
                                            <option value="12"<?php if ($row['grade_level'] == '12') echo ' selected'; ?>>
                                                Grade 12
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row gtr-uniform gtr-50">
                                    <div class="col-12">
                                        <select name="semester" value="" id="tor_purpose" required>
                                ...
                                <div class="col-12">
                                    <ul class="actions">
                                        <li>
                                            <input type="submit" name="reenroll" id="submit" class="primary" />
                                        </li>
                                    </ul>
                                </div>
                            </form>

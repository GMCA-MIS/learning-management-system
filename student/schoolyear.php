            ...
            <div id="content">
                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="add_schoolyearModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            style="margin-bottom: 20px; background-color:  #dfa106; border-color:  #dfa106;"><i class="fa fa-plus" aria-hidden="true"></i>  Add School Year</button>
            </td>
            ...
            <table id = "dataTableID" class="table table-bordered table table-striped" width = "100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <button type="button" class="btn btn-success edit_btn" data-toggle="modal" data-target="#editSchoolYearModal " style="background-color:  #dfa106; border-color:  #dfa106;">View Details</button>
                        </td>
...
<!-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
                        <td>
                            ...
                            <button type="button" class="btn btn-success edit_btn" data-toggle="modal" data-target="#editSchoolYearModal " style="background-color:  #dfa106; border-color:  #dfa106;">Edit</button>
                        </td>
...
if (isset($_POST['add_schoolyear'])) {
    ...
    if (strtotime($end_date) < strtotime($start_date)) {
        ...
        if ($count > 0) {
            ...
            mysqli_query($conn, "insert into school_year (school_year, start_date, end_date) values('$school_year', '$start_date', '$end_date')") or die(mysqli_error());

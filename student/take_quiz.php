                ...
                <div class="card-body text-center">
                    ...
                    <form method="post" id="quiz-form" action="check_answers.php">
                        ...
                        <div id="quiz-container">
                            ...
                            $sql = "SELECT quiz_question.*, question_choices.choice_text 
                            FROM quiz_question
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                if ($quiz_question_id != $currentQuestionID) {
                                ...
                                if ($row['choice_text']) {
                                    $questions[$quiz_question_id]['choices'][] = $row['choice_text'];
                                }

                                $currentQuestionID = $quiz_question_id;
                            }

                            // Display questions, choices, and images
                            foreach ($questions as $quiz_question_id => $questionData) {
                                ?>
                                <div class='question-container mb-4' id='question-<?php echo $quiz_question_id ?>'>
                                    <p class="qnumber">Question
                                        <?php echo $questionNumber ?> of
                                        <?php echo $totalQuestions ?>
                                    </p>
                                    <div class="cardbg text-center mt-5 pb-1">
                                        <h5 class='title font-size-48 mb-0 text-wrap'>
                                            <?php echo $questionData['question_text'] ?>
                                        </h5>
                                        <?php if (!empty($questionData['image'])) { ?>
                                            <img class="img-choice" src='<?php echo $questionData['image'] ?>'
                                                alt='Question Image'
                                                style='max-width: 100%; height: 300px; width: auto; margin: auto; padding-bottom: 5px; display: block;'>
                                        <?php } ?>
                                    </div>
                                    ...
                                    if ($questionData['question_type_id'] == 1 || $questionData['question_type_id'] == 2) { // Multiple Choice or True/False
                                        ...
                                        <div class='row justify-content-center text-center mb-5 mt-4'>
                                            ...
                                            foreach ($questionData['choices'] as $index => $choice) {
                                                $colorClass = 'choice-color-' . ($index + 1); // Generate a class based on the index
                                                ?>
                                                <div class="col-sm-6 col-md-3 mb-3">
                                                    <label class="custom-radio d-flex flex-fill <?php echo $colorClass; ?>">
                                                        <input type="radio" name="question_<?php echo $quiz_question_id ?>"
                                                            value="<?php echo $choice ?>">
                                                        <span class="choice-box flex-fill">
                                                            <p class="choice-text">
                                                                <?php echo $choice ?>
                                                            </p>
                                                        </span>
                                        ...
                                        <div class='custom-input-container'>
                                            <div class='text-center'>
                                                <input type='text' class='custom-input'
                                                    name='question_<?php echo $quiz_question_id ?>' placeholder='Your answer'>
                                            </div>
                                        </div>
                                        <?php
                                    }

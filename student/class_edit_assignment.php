...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="custom-container">
            <h3>Edit Assignment: <?php echo $assignmentName; ?></h3>
            <hr>
            <form class="" action="class_assignments-function.php" method="post" enctype="multipart/form-data" name="upload">
            <input type="hidden" name="assignment_id" value="<?php echo $assignment_id; ?>"> <!-- Add this line -->
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="" id="deadline" name="deadline" required>
                </div>

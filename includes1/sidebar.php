    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper" style="margin-top: 70px;">
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 <?php if (basename($_SERVER['PHP_SELF']) == 'class_grades.php') echo 'active'; ?>" href="class_grades.php<?php echo '?id=' . $get_id; ?>">Enrollment </a>
            </div>
        </div>

...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="../admin/index.php">
    <div class="sidebar-brand-icon">
        <img src="img/slshslogopic.png" alt="">
    </div>
    <div class="sidebar-brand-text mx-3">SLSHS Admin</div>
</a>
...
<li class="nav-item <?php if (in_array(basename($_SERVER['PHP_SELF']), ['manage-class.php', 'manage-students.php'])) echo 'active'; ?>">
    ...
    <div id="collapse4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="manage-class.php?id=<?php echo $school_year?>">  <i class='fas fa-chalkboard'></i> Section List</a>
...
<li class="nav-item <?php if (basename($_SERVER['PHP_SELF']) == 'manage-coordinators.php') echo 'active'; ?>">
  <a class="nav-link" href="manage-coordinators.php">

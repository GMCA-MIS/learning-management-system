...
<header class="bar">
    <div class="logoPic">
        <img src="C:\Users\System Acct\Documents\GitHub\learning-management-system\teacher\includes\gmlogo1.png" alt="logo">
  ...
  <div class="notifi-box" id="box">
    <div class="notifi-scroll">
      ...
      <?php
        ...
        $sql = "SELECT tn.*, s.location AS student_location

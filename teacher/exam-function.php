...
if (isset($_POST['assign_exam'])) {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        if (mysqli_query($conn, $insert_query)) {
            ...
            $notification_query = "INSERT INTO notification (teacher_class_id, notification, date_of_notification, link) VALUES ('$class_id', '$name_notification', NOW(), 'student_exam_list.php')";

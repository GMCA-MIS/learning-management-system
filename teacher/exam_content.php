...
$sql = "SELECT * FROM exam WHERE exam_id = $get_id AND teacher_id = '$teacher_id'";
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4" style="margin-top: 27px; margin-left: 10px;">
                <h1 class="h3 mb-0 text-gray-800">Exam Info: <?php echo $examtitle ?></h1>
            </div>
...
<div class="table-responsive">
    <a href="exam.php" class="btn btn-success">Back</a>
...
<tr>
    ...
    <td><?php echo $row['answer']; ?></td>
                        ...
                        <div class="modal fade" id="delete_questionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <form action="exam-function.php" method = "POST"> 


                                        <div class="modal-body">
                                        
                                                <input type="hidden" name= "delete_ID" id ="delete_ID">
                                                <input type="hidden" name= "exam_id" id ="exam_id" value = "<?php echo $get_id; ?>">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="delete_exam_question" class="btn btn-success">Confirm</button>
                                            </div>
                                    </form>
                                    </div>
                                </div>
    ...
    ?>
                    ...
                    <div class="modal fade" id="add_questionModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="exam-function.php" method="POST" enctype="multipart/form-data">

...
<!--JS for Warning Deleting data from DELETE pop up modal "Quiz Questions" -->
<script>
    $(document).ready(function () {

        $('.delete_btn').on('click', function () {

            $('#delete_questionModal').modal('show');
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        closeBtn.addEventListener("click", function () {
            ...
            // Clear the iframe source to stop displaying the PDF
...
$(document).ready(function () {
    ...
    $('.btn-primary').click(function () {
        // Get the content and announcement_id data attributes
        var content = $(this).data('content');
        var announcement_id = $(this).data('announcement-id');

        // Set the initial values in the modal's form fields
        $('#edit_announcementModal textarea[name="content"]').val(content);
        $('#edit_announcementModal input[name="announcement_id"]').val(announcement_id);
    });
});
</script>

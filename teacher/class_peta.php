                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Create Performance Task</h5>
                        ...
                        <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" id="assignmentTabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active"  style = "color:black;" id="uploadTab" data-toggle="tab" href="#assignments"
                                            role="tab" aria-controls="assignments" aria-selected="false">Performance Task</a>
                                    </li>
                            ...
                            <div class="tab-content" id="assignmentTabsContent">
                                <div class="tab-pane fade show active" id="assignments" role="tabpanel"
                                    ...
                                    <i class="fa fa-plus" aria-hidden="true"></i> Performance Assignment</button>
                                    ...
                                    <div class="custom-container">
                                        ...
                                        $query = "SELECT * FROM task WHERE class_id = '$get_id' AND teacher_id = '$teacher_id' AND status = 'Available'  ORDER BY date_added DESC";
                                ...
                                <div class="tab-pane fade " id="f2f" role="tabpanel" aria-labelledby="createTab">
                                    ...
                                    <div class="custom-container">
                                        ...
                                        // Query to retrieve assignments
                                        $query = "SELECT * FROM task WHERE class_id = '$get_id' AND teacher_id = '$teacher_id' AND status = 'Archived'  ORDER BY date_added DESC";
                                        $result = mysqli_query($conn, $query);
                                    ...
                                    <div class="custom-container">
                                        <div class="header  pb-2 pt-2 pl-4" style="background-color: white;">
                                            <h5>Archived Performance Task</h5>
                                        </div>
                                        <hr>
                                        <?php
                                        // Assuming you have already started the session

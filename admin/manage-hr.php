    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow newtopbar"
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4"
                ...
                <h1 class="h3 mb-0 text-gray-800">Manage Human Resource Accounts</h1>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                    ...
                    <div class="modal fade" id="add_coordinatorModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="manage-hr-func.php" method="POST" oninput='pwd_rpt.setCustomValidity(pwd_rpt.value != pwd.value ? "Passwords do not match." : "")'>
                ...
                <div class="card-body">
                    ...
                    $query = "SELECT *
                            FROM users where user_type = 'humanresource' order by user_id DESC";
                                            ...
                                            <div class="modal fade" id="editManageCoordinatorsModal<?php echo $row['user_id']; ?>" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="manage-hr-func.php" method="POST"  oninput='editpwd_rpt.setCustomValidity(editpwd_rpt.value != editpwd.value ? "Passwords do not match." : "")'>
                        ...
                        <div class="modal fade" id="delete_instructors<?php echo $row['user_id']; ?>" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="manage-hr-func.php" method="POST">

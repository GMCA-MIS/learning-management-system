...
<li class="nav-item <?php if (basename($_SERVER['PHP_SELF']) == 'manage-id-card.php') echo 'active'; ?>">
  ...
  <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="manage-id-card.php?id=<?php echo $school_year ?>"><i class='fas fa-id-card-clip'></i> Manage Library Cards</a>
        <a class="collapse-item" href="generate-id.php?id=<?php echo $school_year ?>"><i class="fas fa-id-card-clip" aria-hidden="true"></i> ID Generator</a>

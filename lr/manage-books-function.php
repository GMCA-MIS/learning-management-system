...
if (isset($_POST['add_book'])) {
    ...
    $imageExtension = pathinfo($book_cover['name'], PATHINFO_EXTENSION);
    ...
    $insertQuery = "INSERT INTO booklist (book_title, author, publication_year, call_number, book_status, image) VALUES ('$category_name', '$uniqueFilename')";

    // Execute the query and move the uploaded file to the directory
    if (mysqli_query($conn, $insertQuery) && move_uploaded_file($book_cover['tmp_name'], $targetFile)) {
        ...
        echo '<script>
                Swal.fire({
                    ...
                    window.location.href = "manage-books.php"; // Redirect to your desired page
                });
              </script>';
    } else {

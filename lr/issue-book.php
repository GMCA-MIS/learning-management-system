                    ...
                    while ($row = $query_run->fetch_assoc()) {
                        ?>
                            <tr>
                                ...
                                <td class="col-3">
                                    <button class="btn btn-warning mr-3 ml-3" type="button" id="borrow" name="borrow" data-bs-toggle="modal" data-bs-target="#borrow_book">
                                        <i class="fa-solid fa-hand"></i>
                                    </button>
                                    <button class="btn btn-info mr-3 ml-3" type="button" id="view-deets" name="view-deets">
                                        <i class="fa-solid fa-eye"></i>
                                    </button>
                                    <button class="btn btn-success mr-3 ml-3" type="button" id="return" name="return">

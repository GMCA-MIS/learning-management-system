...
<?php 
    ...
    $querry = mysqli_query($conn, "SELECT * FROM cards WHERE stud_no= '$id_no' ");
    ...
    $sql = "INSERT INTO `cards`(`name`, `dept`, `cat`, `address`,`email`, `dob`, `stud_no`, `phone`, `image`) VALUES ('$name','$dept','$cat','$address','$email','$dob','$id_no', '$phone', '$uploadfile')"; 
                            ...
                            <table id="dataTableID" class="table table-bordered table table-striped" width="100%"
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        <!--Add Pop Up Modal -->
                                <div class="modal fade" id="<?php echo "editcard". $row['stud_no']; ?>" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Update ID Card
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            ...
                                            <div class="container">
                                                <form method="POST" enctype="multipart/form-data" action="id-card-update-function.php">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <select name="dept" class="custom-select custom-select">
                                                                ...
                                                                <?php if($row['dept'] != 'Computer Studies'){ ?>
                                                                <option value="Computer Studies">Computer Studies</option>
                                                                <?php }
                                                                    if($row['dept'] != 'Education'){
                                                                ?>
                                                                <option value="Education">Education</option>
                                                                <?php }
                                                                    if($row['dept'] != 'Agriculture'){
                                                                ?>
                                                                <option value="Agriculture">Agriculture</option>
                                                                <?php }
                                                                    if($row['dept'] != 'Junior High School'){
                                                                ?>
                                                                <option value="Junior High School">Junior High School</option>
                                                                <?php }
                                                                    if($row['dept'] != 'Senior High School'){
                                                                ?>
                                                                <option value="Senior High School">Senior High School</option>
                                                                <?php }
                                                                ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label for="address">Address</label>
                                                            <input type="text" class="form-control" placeholder="Type your address" name="address" value="<?php echo $row['address']; ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label for="email">Email</label>
                                                            <input type="text" class="form-control" placeholder="Your email" name="email" value="<?php echo $row['email']; ?>">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="birthdate">Birthdate</label>
                                                            <input type="date" class="form-control" id="birthdate" name="dob" value="<?php echo $row['dob']; ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label for="id">ID Card No.</label>
                                                            <input type="text" class="form-control" placeholder="ID No." name="id_no"  value="<?php echo $row['stud_no']; ?>">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <label for="contact">Contact No.</label>
                                                            <input type="text" class="form-control" placeholder="Phone number" name="phone"  value="<?php echo $row['phone']; ?>">
                                                        </div>
                                                    </div>
